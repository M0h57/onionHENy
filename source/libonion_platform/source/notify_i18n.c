...
static const notify_translation_t kTranslations[] = {
    ...
    {"OnionHEN Utility services failed to restart — private elfldr :9020 unavailable",
     "OnionHEN Utility 服务重启失败——私有 elfldr :9020 不可用"},
    {"OnionHEN runtime loader :9020 is unavailable; recovering via :9021...",
     "OnionHEN 运行时加载器 :9020 不可用；正在通过 :9021 恢复..."},
    {"OnionHEN runtime loader recovered on :9020",
     "OnionHEN 运行时加载器已在 :9020 恢复"},
    {"Failed to recover runtime loader :9020; external elfldr :9021 is required",
     "恢复运行时加载器 :9020 失败；需要外部 elfldr :9021"},
    {"User payload autostart skipped: private elfldr :9020 is unavailable",
     "已跳过用户 Payload 自动启动：私有 elfldr :9020 不可用"},
