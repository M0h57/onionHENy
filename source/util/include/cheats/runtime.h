...
#define ORION_DATA_ROOT "/data/OrionHEN"
#define ORION_CHEATS_DIR ORION_DATA_ROOT "/cheats"
...
/**
 * Build flat install name TITLEID_VERSION.ext from GoldHEN/OrionHEN-style
...
/** Walk @p root and copy cheats into ORION_CHEATS_DIR as flat names. */
