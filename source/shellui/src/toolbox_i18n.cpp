...
constexpr Entry kTable[] = {
  ...
  {"group.pkg", "软件包安装", "Package Install"},
  {"group.pkg.sub", "安装 PKG 与附加内容", "Install PKGs and add-on content"},
  {"group.payloads", "Payload 与内核", "Payloads & Kernel"},
  {"group.payloads.sub", "Payload ELF 与 Kstuff", "Payload ELFs and Kstuff"},
  {"group.game", "游戏功能", "Game Features"},
  {"group.game.sub", "金手指、远程游玩与游戏内覆盖层", "Cheats, Remote Play, and in-game overlay"},
  {"group.system", "系统设置", "System"},
  {"group.system.sub", "权限、硬件、存储与休息模式", "Permissions, hardware, storage, and rest mode"},
  ...
  {"group.debug", "调试选项", "Debug"},
  {"group.debug.sub", "越狱调试与环境", "Jailbreak debug and environment"},
  ...
  {"kstuff.download", "通过 GitHub 替换为最新 Kstuff", "Replace with latest Kstuff from GitHub"},
  {"kstuff.download.desc",
   "从 EchoStretch 的 GitHub 仓库下载并安装最新 kstuff，替换 OnionHEN 启动时自动加载的版本",
   "Download and install the latest kstuff from EchoStretch's GitHub; replaces the auto-loaded build"},
  {"kstuff.delete", "删除通过 GitHub 安装的 Kstuff", "Remove GitHub-installed Kstuff"},
  {"kstuff.delete.desc", "将切换回 OnionHEN 内置的 kstuff", "Falls back to the built-in kstuff"},

  // Game
  {"cheats.link", "金手指（开发中）", "Cheats (WIP)"},
  ...
  {"game_opts.toggle.sub",
   ...
   "Show OnionHEN options in the game menu (cheats, dump, etc.)"},
  {"overlay.group", "游戏覆盖层", "Game Overlay"},
  {"overlay.group.sub", "贴边全宽横条 + 半透明黑底（PHU flex banner）",
   "Edge-to-edge bar + translucent black (PHU flex banner)"},
  {"overlay.pos", "监控条位置", "Monitor bar position"},
  {"overlay.pos.sub", "贴屏幕边缘、宽度 100%；指标居中：FPS · CPU · GPU · RAM · IP",
   "Full width at screen edge; metrics centered: FPS · CPU · GPU · RAM · IP"},
  {"overlay.pos.top", "顶部贴边", "Top edge"},
  {"overlay.pos.bottom", "底部贴边", "Bottom edge"},
  {"overlay.fps", "*实验性* FPS", "*Experimental* FPS"},
  {"overlay.fps.desc", "显示 FPS 段（依赖游戏内 FPS 字符串捕获，可能不稳定）",
   "Show FPS segment (depends on in-game FPS string capture; may be unstable)"},
  {"overlay.gpu", "GPU", "GPU"},
  ...
  {"auto_eject", "OnionHEN 启动时自动弹出光盘", "Auto-eject disc when OnionHEN starts"},
  {"auto_eject.desc",
   "OnionHEN 完全启动后自动弹出已插入的光盘，适用于 BD-J 或 LUA 漏洞利用",
   "Eject inserted disc after OnionHEN fully starts (BD-J / LUA exploits)"},
  {"confirm.reboot_next", "更改将在下次重启后生效", "Changes apply after the next reboot"},
  ...
  // About (UI chrome only; proper names stay as-is)
  {"about.donate", "支持本项目", "Support this project"},
  {"about.donate.sub", "喜欢这个项目吗？欢迎捐赠支持", "Like the project? Donations are welcome"},
  {"about.donate.methods", "★ 捐赠方式", "★ Donation methods"},
  {"about.credits", "OnionHEN 致谢", "OnionHEN Credits"},
  {"about.credits.sub", "致谢与支持者", "Credits and supporters"},
  {"about.lead", "★ 主要开发者 ★", "★ Lead developers ★"},
  {"about.contributors", "★ OnionHEN 贡献者 ★", "★ OnionHEN contributors ★"},
  {"about.more", "更多信息、更新或问题请访问 GitHub 仓库",
   "For more info, updates, or issues visit the GitHub repository"},
  {"about.repo", "OnionHEN 项目仓库", "OnionHEN project repository"},
  {"about.thanks", "特别感谢所有支持者，包括以下人员：",
   "Special thanks to all supporters, including:"},
  {"about.projects", "OnionHEN 所包含的项目", "Projects included in OnionHEN"},
  {"about.projects.sub", "OnionHEN 中使用的项目", "Projects used by OnionHEN"},
  {"about.projects.info", "★ OnionHEN 中使用的开源与闭源项目",
   "★ Open- and closed-source projects used in OnionHEN"},
  {"about.elfldr_etc", "John tornblom - elfldr 等", "John tornblom - elfldr, etc."},
  ...
  {"cheats.repo", "金手指仓库来源", "Cheat repository"},
  {"cheats.repo.onion", "OnionHEN PS5 金手指仓库", "OnionHEN PS5 cheat repo"},
  {"cheats.repo.gold", "GoldHEN PS4 金手指仓库", "GoldHEN PS4 cheat repo"},
  {"cheats.dl", "下载/更新金手指", "Download / update cheats"},
  {"cheats.dl.desc",
   "从所选 GitHub 仓库下载到 /data/OnionHEN/cheats/（TITLEID_VERSION.ext）",
   "Download from the selected GitHub repo to /data/OnionHEN/cheats/ (TITLEID_VERSION.ext)"},
